...
type (
	...
	GetSalesTotalDataRequest struct {
		...
		Status     SalesData `json:"status"`     // Задаргаа авч буй баримтын төрөл
...
type (
	...
	ReceiptRequest struct {
		...
		Type         ReceiptType `json:"type"`         // Баримтын төрөл
	...
	Receipt struct {
		...
		TaxType       TaxType     `json:"taxType"`       // Татварын төрөл
	...
	Item struct {
		...
		BarCodeType        BarcodeType `json:"barCodeType"`        // Зураасан кодын төрөл
	...
	Payment struct {
		Code         PaymentCode   `json:"code"`         // Төлбөрийн хэлбэрийн код
		ExchangeCode string        `json:"exchangeCode"` // Төлбөр хийж гүйцэтгэх гуравдагч системийн код
		Status       PaymentStatus `json:"status"`       // Төлбөрийн хэлбэрийн төлөв
	...
	ReceiptResponse struct {
		...
		Status       PosStatus   `json:"status"`       // Баримтын төлөв
